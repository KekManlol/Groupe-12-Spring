...
public class WalletController {
  ...
  public ResponseEntity<Iterable<Position>> addPositions(@PathVariable String username, @RequestBody List<Position> positions) {
    Iterable<Position> updatedPositions = service.addPositions(username, positions);
  ...
  public ResponseEntity<Iterable<Position>> getOpenPositions(@PathVariable String username) {
    Iterable<Position> openPositions = service.getOpenPositions(username);
